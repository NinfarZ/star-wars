        ...
        {starship.films.length > 0 && (
          <div className="mb-5">
            ...
            <Suspense fallback={<ItemsSkeleton count={starship.films.length} />}>
              <LinkedResourceList<Film> urls={starship.films} queryKey="film" routePath="films" getLabel={(film) => film.title} />
            </Suspense>
          </div>
        )}
        ...
        {starship.pilots.length > 0 && (
          <div>
            ...
            <Suspense fallback={<ItemsSkeleton count={starship.pilots.length} />}>
              <LinkedResourceList<Person> urls={starship.pilots} queryKey="person" routePath="people" getLabel={(person) => person.name} />
            </Suspense>
          </div>
        )}
      </section>
